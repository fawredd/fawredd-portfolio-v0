...
const mockRepositories: Repository[] = [
  {
    id: 99,
    name: "etercell.com",
    description: "Website about WordPress using a template from Plethora Themes.",
    html_url: "https://github.com/fawredd/clinical",
    homepage: "https://fawredd-clinical.vercel.app",
    topics: ["PHP","WORDPRESS", "UI/UX", "Terapias regenerativas", "Productos autologos", "Biomedicina"],
    language: "PHP",
